...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\JusticiaType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\JusticiaType']) ? $this->services['AppBundle\Form\JusticiaType'] : ($this->services['AppBundle\Form\JusticiaType'] = new \AppBundle\Form\JusticiaType())) && false ?: '_'};
}, 'AppBundle\\Form\\VillanoType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\VillanoType']) ? $this->services['AppBundle\Form\VillanoType'] : ($this->services['AppBundle\Form\VillanoType'] = new \AppBundle\Form\VillanoType())) && false ?: '_'};
